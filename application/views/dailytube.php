...
<div class="container-fluid" style="margin-top:80px">
  <div class="row content">
    ...
    <nav class="hidden-xs col-sm-2 col-md-2 col-lg-2" id="myScrollspy">
    ...
    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
      <!--Menu horizontal-->
      <div class="row no-pad btn-group hidden-xs col-sm-12 col-md-12 col-lg-12 text-center" id="accueil">
      ...
      <div class="row no-padding no-margin-bottom panel-group" id="Films">
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
          ...
          <!-- modal
          <a href="#" id="pop">
            <img id="imageresource" src="assets/images/koala.jpg">
            Click to Enlarge
          </a>
          -->
